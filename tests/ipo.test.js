...
test('getIpo no arguments', async () => {
    a = await te.getIpo();
    b = await fetch('https://api.tradingeconomics.com/ipo?c=&f=json');
    c = await b.json();
...
test('getIpo with ticker argument', async () => {
    ...
    b = await fetch('https://api.tradingeconomics.com/ipo/ticker/SWIN?c=&f=json');
    c = await b.json();
...
test('getIpo with country argument', async () => {
    ...
    b = await fetch('https://api.tradingeconomics.com/ipo/country/United States?c=&f=json');
    c = await b.json();
...
test('getIpo with country and date argument', async () => {
    ...
    b = await fetch('https://api.tradingeconomics.com/ipo/country/United States?c=&f=json&d1=2023-09-01&d2=2023-12-01');
    c = await b.json();
...
test('getIpo with ticker and date argument', async () => {
    ...
    b = await fetch('https://api.tradingeconomics.com/ipo/ticker/SWIN?c=&f=json&d1=2023-09-01&d2=2023-12-01');
    c = await b.json();
