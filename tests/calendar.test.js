...
describe('getCalendar', () => {
    ...
    test('getCalendar with country and start_date and end_date argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/country/united states,china/2016-02-01/2016-02-10?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendar with country, indicator,start_date and end_date argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/country/united states/indicator/Initial Jobless Claims/2024-02-01/2024-03-30?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendar with country and indicator argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/country/united states/indicator/Initial Jobless Claims?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendar with indicator and start_date and end_date argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/indicator/inflation rate/2016-03-01/2016-03-03?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendar indicator argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/indicator/inflation rate?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendar with ticker and start_date and end_date argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/ticker/IJCUSA/2016-02-01/2016-02-10?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendar with multiple id argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/calendarid/174108,160025,160030?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendar with id argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/calendarid/174108?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendar with ticker argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/ticker/IJCUSA?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendar with multiple ticker argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/ticker/IJCUSA,SPAINFACORD,BAHRAININFNRATE?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendar with multiple countries', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/country/united states,china?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendar with start_date and end_date argument', async () => {
        ...
        b = await fetch('https://api.tradingeconomics.com/calendar/country/All/2016-02-01/2016-02-10?c=&f=json');
        c = await b.json();
    ...
    test('getCalendar with country argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/country/united states?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendar no arguments', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar?c=&f=json');
        let c = await b.json();
    ...
    test('get calendar event with country and event argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/country/united states/event/GDP Growth Rate QoQ Final/2016-12-01/2024-02-25?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendar with importance and values argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar?c=&f=json&importance=1&values=true');
        let c = await b.json();
...
describe('getCalendarEventsByGroup', () => {
    ...
    test('getCalendarEventsByGroup with start_date argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/group/bonds/2023-01-01?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendarEventsByGroup', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/group/bonds?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendarEventsByGroup with country arguments', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/country/united states/group/bonds/?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendarEventsByGroup with dates arguments', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/group/bonds/2023-01-01/2023-12-01?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendarEventsByGroup with country and dates arguments', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/country/united states/group/bonds/2023-01-01/2023-12-01?c=&f=json');
        let c = await b.json();
...
describe('getCalendarEvents', () => {
    ...
    test('getCalendarEvents', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/events?c=&f=json');
        let c = await b.json();
    ...
    test('getCalendarEvents with country argument', async () => {
        ...
        let b = await fetch('https://api.tradingeconomics.com/calendar/events/country/united states?c=&f=json');
        let c = await b.json();
