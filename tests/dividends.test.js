...
test('getDividends no arguments', async () => {
    ...
    b = await fetch('https://api.tradingeconomics.com/dividends?c=&f=json');
    c = await b.json();
...
test('getDividends with symbol argument', async () => {
    ...
    b = await fetch('https://api.tradingeconomics.com/dividends/symbol/aapl:us?c=&f=json');
    c = await b.json();
...
test('getDividends with symbol and start_date arguments', async () => {
    ...
    b = await fetch('https://api.tradingeconomics.com/dividends/symbol/aapl:us?c=&f=json&d1=2018-01-01');
    c = await b.json();
...
test('getDividends with symbol, start_date and end_date arguments', async () => {
    ...
    b = await fetch('https://api.tradingeconomics.com/dividends/symbol/aapl:us?c=&f=json&d1=2018-01-01&d2=2019-01-01');
    c = await b.json();
